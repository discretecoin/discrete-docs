...
Block v1's ID hashes the unsigned blob and omits $\sigma_B$, although full block
serialization includes it. Nodes still recompute the signature and PoW on
admission; a header-only cache entry is not a verdict. A signature-committing ID
is future hard-fork work requiring regenerated genesis, checkpoints, and vectors.
